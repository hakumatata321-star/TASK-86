...
func init() {
	// Use the minimum bcrypt cost in all tests to avoid multi-second hashes
	// per login call.  Tests that import testutil get this automatically.
	crypto.BCryptCost = bcrypt.MinCost
}
